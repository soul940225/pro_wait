# Generated by Django 2.0 on 2018-12-04 05:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_enter', models.SmallIntegerField(choices=[(0, '未入驻'), (1, '已入驻')], default=0, verbose_name='入驻')),
            ],
            options={
                'verbose_name': '学校信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('head_image', models.ImageField(default='', upload_to='user/%Y/%m', verbose_name='用户头像')),
                ...
                ('school', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='user.School', verbose_name='学校id')),
            ],
            options={
                'verbose_name': '用户信息',
